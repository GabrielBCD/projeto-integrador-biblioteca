...
<body>
<div class="container">
    <div class="login shadow rounded p-4 m-auto mt-5">
        <div class="text-center mb-3">
            ...
            <h1 class="fs-2 d-inline-block ms-1">Library - Entrar</h1>
        </div>
        <form action="" method="GET">
            <div class="form-floating mb-3">
                <input type="text" class="form-control form-control-sm" id="user" name="user" placeholder="">
